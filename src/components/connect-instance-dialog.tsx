...
import { startInstanceSession } from "@/app/actions/instances"
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] flex flex-col items-center text-center">
                ...
                <div className="py-6 flex flex-col items-center gap-4 w-full">
                    ...
                    <div className="flex items-center justify-center w-[250px] h-[250px] bg-muted rounded-lg overflow-hidden transition-all duration-300">
                        {isLoading ? (
