    ...
    return (
        <>
            <Card className="overflow-hidden group hover:shadow-md transition-shadow">
                <CardContent className="p-0 flex flex-col items-center justify-center bg-muted/20 relative">
                    {/* Badge Overlay */}
                    <div className="absolute top-2 right-2 z-10">
                        <Badge variant="secondary" className="opacity-75 font-mono text-[10px]">
                            {getTypeLabel()}
                        </Badge>
                    </div>

                    <div className="w-full aspect-video flex items-center justify-center bg-background border-b overflow-visible relative">
                        {isImage ? (
                            <img
                                src={file.url}
                                alt={file.name}
                    ...
                    <div className="p-4 text-center w-full">
                        <p className="font-medium truncate w-full text-sm" title={file.name}>
                            {file.name}
                        </p>
                ...
                <CardFooter className="p-2 gap-2 justify-end bg-card border-t">
